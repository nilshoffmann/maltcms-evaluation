...
evalBaseDir = new File(baseDir,"../SWPA").canonicalFile
...
rtTolerance = [30.0,60.0,120.0,180.0,200.0,220.0]
//rtTolerance = [20.0]
...
minCliqueSize = [2]//,4,6,8,10,12,14,16]
...
guineu {
	...
	args = [
		"--input ":["<IN>"],
		"--output ":["<OUT>"],
		"--rt1Penalty ": [0.25,0.5,0.75,0.99],
		"--rt2Penalty ": [0.25,0.5,0.75,0.99],
		"--rtiPenalty ": [0.0],
