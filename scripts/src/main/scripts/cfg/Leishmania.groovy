...
evalName = "Leishmania_Evaluation"
...
evalBaseDir = new File(baseDir,"../Robinson2007")
//location of raw data
dataDir = new File(evalBaseDir,"data")
//location of peak data
featureDir = new File(evalBaseDir,"groundTruth/peakData")
featureFileSuffix = "*.csv"
robinsonDir = new File(evalBaseDir,"robinson/")
...
//virtualMemoryLowerBound = 2
//virtualMemoryUpperBound = 4 
//cpusPerJob = 4
virtualMemoryLowerBound = 2
virtualMemoryUpperBound = 4 
cpusPerJob = 1
...
multipleAlignmentFile = "multiple-alignmentRT.csv"
//location of the ground truth file to compare against
groundTruthFile = new File(evalBaseDir,"groundTruth/groundTruth.csv")
/*
 *  execution settings
 */
...
rtTolerance = [0.1,0.25,0.5,1.0,2.0,2.5,3.0]
...
minCliqueSize = [2,3,4,5,6,7,8]
/*
 *  cemappDtw specific
 */
//retention time tolerance
rtToleranceDtw = [0.5,1.0,2.0,2.5,3.0]
